...
//				JSONObject orderItem = new JSONObject();
                ...
                String APPLYUNIT = CoreUtil.objToStr(dataMap.get("APPLYUNIT"));
                ...
                String APPLYUSERNZH = CoreUtil.objToStr(dataMap.get("APPLYUSERNZH"));
                String NEEDCENUM = CoreUtil.objToStr(dataMap.get("NEEDCENUM"));
...
//                            itemRecordData.set("MANYIDU", "基本满意");
                    ...
                    if (actionflag > 0) {
                        int updateflag = DBSql.update("UPDATE BO_EU_MYD_CEPING_YB_UNITJB SET ISSTARTCEPING = '是' " +
                                "WHERE ID = '" + ID + "'");
