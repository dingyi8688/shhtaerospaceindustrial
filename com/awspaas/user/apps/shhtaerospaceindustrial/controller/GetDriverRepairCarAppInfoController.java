...
@Controller
public class GetDriverRepairCarAppInfoController {
    /**
     * 车辆保养微信申请单列表
     *
     * @param uc
     * @param roleType  1：驾驶员|2：调度|
     * @param bDate
     * @param eDate
     * @param page
     * @param pageCount
     ...
     * @return
     */
    @Mapping("shsy.getRepairCarAppInfoList")
...
//			userId = "gcbdd1";//测试
            ...
            //涉及自己的代办
            String querySql1 = "select rownum rn,t.APPDATE,t.APPUSER,t.CARNO,t.REPAIRREASON,wfc.processinstid wf_processinstid,wfc.id wf_id " +
                    "from BO_EU_BZCARREPAIR_APP t " +
            ...
            //涉及自己的已办
            String querySql2 = "select rownum rn,t.APPDATE,t.APPUSER,t.CARNO,t.REPAIRREASON,wfh.processinstid wf_processinstid,wfh.id wf_id " +
                    "from BO_EU_BZCARREPAIR_APP t " +
            ...
            if (dataList == null || dataList.isEmpty()) {
                ...
                returnData.put("message", "没有任何访维修保养申请记录");
                return returnData.toString();
            }
...
//				}
                ...
                String REPAIRREASON = CoreUtil.objToStr(dataMap.get("REPAIRREASON"));
//				String cnname = CoreUtil.objToStr(dataMap.get("cnname"));
                ...
                orderItem.put("repairreason", REPAIRREASON);
