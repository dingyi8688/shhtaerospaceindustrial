...
public class AppUserCmd {
    ...
    public String userCancelMission(String ids, String processInstId, String id, UserContext uc) {
        ...
        String queryInfoSql = "select a.UDATE, a.CPH,a.SJXM, a.SJLXFS,a.bindid,a.SJZH,a.APPLYUSERNAME,a.APPLYUID,a.APPLYUSERCELLPHONE,a.UDATE,a.CPH,a.VEHICLETYPE,a.CONTACTPERSON,a.CONTACTPHONE,RESOURCETASKFPID from BO_EU_SH_VEHICLEORDER_MISSION a WHERE BINDID = "
                + "'" + processInstId + "'";
        ...
        String PDRECODRID = CoreUtil.objToStr(DBSql.getString(queryInfoSql, "RESOURCETASKFPID"));
        ...
        String xgztsql = "update BO_EU_SH_VEHICLEORDER_ASSIGMIS set ZT='2',MISSIONSTATUS='6' where id in (" + PDRECODRID + ")";
